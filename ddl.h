...
public:
    ...
    void SetDDL(int, bool, bool, QString, QString,
                 QString, DDL*, DDL*);// 设置DDL
    void SetCompletDeg(int);          // 设置任务完成度，返回设置是否成功
    void SetCompletState(bool);       // 设置任务完成状态，返回设置是否成功
    void SetTurnInState(bool);        // 设置任务提交状态，返回设置是否成功
    void SetDescirp(const QString&);  // 设置DDL的描述性文字，返回设置是否成功
    void SetDuration(const QString&); // 设置任务持续时间，返回设置是否成功
    void SetPrev(DDL*);               // 设置前驱任务，返回设置是否成功
    void SetNext(DDL*);               // 设置后继任务，返回设置是否成功
    ...
    // 常引用作为私有变量的公有只读版本
    const int& CompletDegree;
    const bool& CompletState;
    const bool& TurnInState;
